...
<head>
    ...
    <link rel="icon" href="{{url('almaris/images/icon.png')}}" type="image/gif" sizes="16x16">
    ...
    <!-- color scheme -->
    <link id="colors" href="{{url('almaris/css/colors/scheme-02.css')}}" rel="stylesheet" type="text/css">
    <style>
        .floating-button {
            position: fixed;
            bottom: 20px;
...
<body>
    ...
    <script src="{{url('almaris/js/custom-swiper-2.js')}}"></script>
