      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 position-lg-absolute {{ ($loop->index % 2 == 0) ? 'right-half' : 'left-half' }} h-100">
            <div class="image" data-bgimage="url({{env('APP_URL')}}/almaris/images/room/1.webp) center"></div>
          </div>
          <!-- Text -->
          <div class="col-lg-6 {{ ($loop->index % 2 == 0) ? 'py-5 pe-lg-5' : 'offset-lg-6 py-5 ps-lg-5' }}">
                ...
                <a class="btn-main mt-2" href="{{route('hotel.rooms.show',['hotel' => $hotel['id'], 'category' => $category['id'] ] )}}">Book Now</a>
