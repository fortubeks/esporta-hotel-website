                ...
                <div class="owl-custom-nav menu-float px-5" data-target="#room-carousel">
                    ...
                    <div id="room-carousel" class="owl-3-cols owl-carousel owl-theme">
                        ...
                        <div class="item">
                            ...
                            <div class="mt-3">
                                <p>Step into our luxurious hotel rooms, where sophistication meets comfort. Nestled in
                                    the heart of the city, our rooms offer a serene escape from the hustle and bustle.
                                </p>
                                ...
                                <div class="d-inline">
                                    ...
                                    <div class="d-tagline-s2">
                                        ...
                                        <div class="text">1 Queen Bed</div>
                                    </div>
                        ...
                        <div class="item">
                            <div class="hover relative text-light text-center wow fadeInUp" data-wow-delay=".4s">
                                <img src="{{env('APP_URL')}}/almaris/images/room/room1.jpg" class="w-100 rounded-up-100"
                                    alt="">
                                <div class="abs hover-op-1 z-4 hover-mt-40 abs-centered">
                                    <div class="fs-14">From</div>
                                    <h3 class="fs-40 lh-1 mb-4">₦32,000</h3>
                                </div>
                                <div class="abs bg-color z-2 top-0 w-100 h-100 hover-op-1 rounded-up-100"></div>
                                <div class="abs z-2 bottom-0 mb-3 w-100 text-center hover-op-0">
                        ...
                        <div class="item">
                            <div class="hover relative text-light text-center wow fadeInUp" data-wow-delay=".5s">
                                <img src="{{env('APP_URL')}}/almaris/images/room/room3.jpg" class="w-100 rounded-up-100"
                                    alt="">
                                <div class="abs hover-op-1 z-4 hover-mt-40 abs-centered">
                                    <div class="fs-14">From</div>
                                    <h3 class="fs-40 lh-1 mb-4">₦45,000</h3>
                                </div>
                                <div class="abs bg-color z-2 top-0 w-100 h-100 hover-op-1 rounded-up-100"></div>
                                <div class="abs z-2 bottom-0 mb-3 w-100 text-center hover-op-0">
                                    <h3 class="mb-0">Executive Room</h3>
                                    <div class="text-center fs-14">
                                        <span class="mx-2">
                                            2 Guests
                                        </span>
                        ...
                        <div class="item">
                            <div class="hover relative text-light text-center wow fadeInUp" data-wow-delay=".7s">
                                <img src="{{env('APP_URL')}}/almaris/images/room/room.jpg" class="w-100 rounded-up-100"
                                    alt="">
                                <div class="abs hover-op-1 z-4 hover-mt-40 abs-centered">
                                    <div class="fs-14">From</div>
                                    <h3 class="fs-40 lh-1 mb-4">48,000</h3>
                                </div>
                                <div class="abs bg-color z-2 top-0 w-100 h-100 hover-op-1 rounded-up-100"></div>
                                <div class="abs z-2 bottom-0 mb-3 w-100 text-center hover-op-0">
                                    <h3 class="mb-0">Luxury Room</h3>
                                    <div class="text-center fs-14">
                                        <span class="mx-2">
                                            4 Guests
                                        </span>
                        ...
                        <div class="item">
                            <div class="hover relative text-light text-center wow fadeInUp" data-wow-delay=".7s">
                                ...
                                <div class="abs hover-op-1 z-4 hover-mt-40 abs-centered">
                                    <div class="fs-14">From</div>
                                    <h3 class="fs-40 lh-1 mb-4">53,000</h3>
                                </div>
                                <div class="abs bg-color z-2 top-0 w-100 h-100 hover-op-1 rounded-up-100"></div>
                                <div class="abs z-2 bottom-0 mb-3 w-100 text-center hover-op-0">
                                    <h3 class="mb-0">Diplomatic Suite</h3>
                                    <div class="text-center fs-14">
                                        <span class="mx-2">
                                            4 Guests
                                        </span>
                        ...
                        <div class="item">
                            <div class="hover relative text-light text-center wow fadeInUp" data-wow-delay=".7s">
                                ...
                                <div class="abs hover-op-1 z-4 hover-mt-40 abs-centered">
                                    <div class="fs-14">From</div>
                                    <h3 class="fs-40 lh-1 mb-4">57,000</h3>
                                </div>
                                <div class="abs bg-color z-2 top-0 w-100 h-100 hover-op-1 rounded-up-100"></div>
                                <div class="abs z-2 bottom-0 mb-3 w-100 text-center hover-op-0">
                                    <h3 class="mb-0">Ambassadorial Suite</h3>
                                    <div class="text-center fs-14">
                                        <span class="mx-2">
                                            4 Guests
                                        </span>
