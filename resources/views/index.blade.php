        ...
        <div class="row g-4">
                ...
                <div class="relative wow fadeInUp" data-wow-delay=".3s">   
                    <div class="abs top-0 w-100">
                        <div class="shape-mask-1 jarallax">
                            <img src="almaris/images/misc/6.webp" class="jarallax-img" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 sm-hide">
                <div class="relative wow fadeInUp" data-wow-delay=".3s">                                
                    <div class="abs top-0 w-100">
                        <div class="shape-mask-1 jarallax">
                            <img src="almaris/images/misc/5.webp" class="jarallax-img" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div id="room-carousel" class="owl-3-cols owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <div class="hover relative text-light text-center wow fadeInUp" data-wow-delay=".3s">
                                <img src="almaris/images-beach-resort/room/1.webp" class="img-fluid" alt="">
                        ...
                        <div class="item">
                            <div class="hover relative text-light text-center wow fadeInUp" data-wow-delay=".4s">
                                <img src="almaris/images-beach-resort/room/2.webp" class="img-fluid" alt="">
                                <div class="abs hover-op-1 z-4 hover-mt-40 abs-centered">
                                    <div class="fs-14"></div>
                                    <h3 class="fs-40 lh-1 mb-4"></h3>
                        ...
                        <div class="item">
                            <div class="hover relative text-light text-center wow fadeInUp" data-wow-delay=".5s">
                                <img src="almaris/images-beach-resort/room/3.webp" class="img-fluid" alt="">
                                <div class="abs hover-op-1 z-4 hover-mt-40 abs-centered">
                                    <div class="fs-14"></div>
                                    <h3 class="fs-40 lh-1 mb-4"></h3>
                        ...
                        <div class="item">
                            <div class="hover relative text-light text-center wow fadeInUp" data-wow-delay=".7s">
                                <img src="almaris/images-beach-resort/room/4.webp" class="img-fluid" alt="">
                                <div class="abs hover-op-1 z-4 hover-mt-40 abs-centered">
                                    <div class="fs-14"></div>
                                    <h3 class="fs-40 lh-1 mb-4"></h3>
    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-4 wow fadeInRight" data-wow-delay=".0s">
                ...
                <img src="almaris/images-beach-resort/misc/home-restaurant.webp" class="w-100" alt="">
            </div>
            ...
            <div class="col-lg-4 wow fadeInRight" data-wow-delay=".2s">
                ...
                <img src="almaris/images-beach-resort/misc/home-recreation.webp" class="w-100" alt="">
            </div>
                ...
                <div class="relative">
                    <div class="row g-3 align-items-center">
                        <div class="col-6 wow fadeInUp" data-wow-delay=".2s">
                            <img src="almaris/images-beach-resort/misc/home-food-1.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="col-6 wow fadeInUp" data-wow-delay=".4s">
                            <img src="almaris/images-beach-resort/misc/home-food-2.jpg" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
            </div>
